      ...
      <main className="relative z-10 mx-auto max-w-5xl px-4 sm:px-6 lg:px-16 py-16">
        ...
        >
          ...
          <div className="space-y-5 text-ink-soft">
            ...
            <p className="leading-relaxed">
              By accessing and using the QUANTIFAI website and using the Services, you agree to the terms and conditions of this Privacy Policy. If you do not agree to the terms and conditions of this Privacy Policy, please do not access or use the QUANTIFAI website or use the Services.
            </p>
            <p className="leading-relaxed">
